    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                <p class="search-text">用户编号</p>
                <el-input v-model="query.NumberID" placeholder="请输入用户编号" class="handle-input mr20"></el-input>
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header">
                ...
                <el-table-column prop="UserPermissions" label="权限(是否为管理员)" align="center">
        ...
        <el-dialog title="编辑" v-model="add.visible" width="30%">
            <el-form label-width="150px">
                <el-form-item label="权限(是否为管理员)">
                    <el-input v-model="form.UserPermissions"></el-input>
                </el-form-item>
            </el-form>
            <template #footer>
